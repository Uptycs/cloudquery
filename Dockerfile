...
COPY extension/elb/workspaces/table_config.json /opt/cloudquery/etc/aws/elb/
COPY extension/elbv2/workspaces/table_config.json /opt/cloudquery/etc/aws/elbv2/
