...
func readTableConfigurations() {
	...
	//utilities.ReadTableConfig(*homeDirectory + string(os.PathSeparator) + "aws/ec2/table_config.json")
	...
	//utilities.ReadTableConfig(*homeDirectory + string(os.PathSeparator) + "aws/s3/table_config.json")
	...
	//utilities.ReadTableConfig(*homeDirectory + string(os.PathSeparator) + "gcp/compute/table_config.json")
